    ...
    <section className=" bg-[##fcfcfc] relative w-full py-0 md:py-16 font-[family-name:var(--font-apfel)]">
      <div className=" px-6 md:px-24 relative flex items-center justify-center">
        ...
        <div className="mt-12 md:mt-8 flex flex-col items-start w-full max-w-3xl md:pl-20">
          <h2 className="flex flex-col text-5xl sm:text-6xl md:text-7xl lg:text-[6rem] font-semibold tracking-tight sm:tracking-tighter leading-[1.0] sm:leading-[0.95]">
            <span className="text-[#0d0d0db3]">Bold Ideas,</span>
            <span className="text-zinc-950 font-semibold">Flawless</span>
            <span className="text-zinc-950 font-semibold">Execution</span>
          </h2>
        </div>
