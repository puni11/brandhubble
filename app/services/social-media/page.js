...
export default function Page(){
    return(
        <div className="mt-12">
            <ProjectsHeader2 title="Service" subtitle2="Social Media Marketing & Content Strategy Services " description="Data-Driven Marketing for Measurable Results" />
...
Our process is built to blend creativity with clarity, and momentum with metrics. Every step ensures your content is aligned with your brand voice, speaks to the right audience, and drives the outcomes you care about most. </p>
          </div>
        </div>
